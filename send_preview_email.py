...
GMAIL_PASS = "your_app_password"  # Use Gmail App Password if 2FA enabled
...
REPO_BASE_URL = "https://github.com/quandri01/rileys_reef/blob/main"  # adjust if repo differs
...
def send_preview(creature):
    ...
    <p>
    <a href="{APPROVE_LINK}?creature={creature}" 
       style="background:green;color:white;padding:10px;text-decoration:none;margin-right:10px;">
       ✅ Approve & Send
    </a>
    <a href="{REJECT_LINK}?creature={creature}" 
